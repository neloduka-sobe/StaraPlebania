      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex justify-between mb-4">
            ...
            <div className="flex items-center text-gray-600">
              <span>{t("apartments.from")} {apartment.price} zł {t('apartments.perNight')}</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
            <button 
              ...
              className="flex-1 bg-green-100 text-green-600 px-4 py-2 rounded-lg font-medium hover:bg-green-200 transition-colors flex items-center justify-center"
            >
